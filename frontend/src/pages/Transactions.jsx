        ...
        >
          ...
          <div className="flex justify-between items-start">
            ...
            <p className="text-xs text-on-surface-variant font-body mt-2">
              Showing {txs.length} of {stats.total} transactions
            </p>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-right flex items-center gap-3">
                      <span
                        className={`badge-${tx.status === "completed" ? "success" : tx.status === "pending" ? "pending" : "error"} capitalize`}
                      >
                        {tx.status}
                      </span>
                      <p
                        className={`font-headline font-semibold text-sm min-w-20 text-right ${isIncoming ? "text-tertiary" : "text-error"}`}
                      >
                        {isIncoming ? "+" : "-"}
                        {fmt(tx.amount)}
                      </p>
                      <span className="material-icons text-on-surface-variant text-base group-hover:text-primary transition-colors">
                        chevron_right
                      </span>
                    </div>
                  </motion.div>
